...
impl Window {
    ...
    pub fn new(bounds: Rect, title: &str) -> Self {
        use crate::core::palette::{Attr, Palette, WINDOW_BACKGROUND, palettes};
...
impl WindowBuilder {
    ...
    pub fn build(self) -> Window {
        ...
        Window::new_with_palette(bounds, &title, super::frame::FramePaletteType::Editor, interior_color, WindowPaletteType::Blue, self.resizable)
    }
}
