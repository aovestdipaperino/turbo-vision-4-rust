...
use turbo_vision::views::{
    ...
    help_context::{HelpContext, HC_NO_CONTEXT},
};
use std::rc::Rc;
...
fn main() -> std::io::Result<()> {
    ...
    // Welcome button
    let welcome_btn = Button::new(
        Rect::new(20, 12, 34, 14),
        "~W~elcome",
        100,
        false
    );
    ...
    // File Menu button
    let file_btn = Button::new(
        Rect::new(36, 12, 48, 14),
        "~F~ile",
        101,
        false
    );
